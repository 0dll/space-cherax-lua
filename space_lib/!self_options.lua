...
function _self_options_main_()
    ...
    _hot_key_tbl.ped_wetness, _settings.ped_wetness_value = add_toggle_editor_option("Ped Wetness", "Why Exactly Are You Using This -_-", submenus.self_main_menu, _hot_key_tbl.ped_wetness, true, _settings.ped_wetness, _settings.ped_wetness_value, -1.10, 0.75, 0.05, function() to_enable.option_ped_wetness(true) end)
